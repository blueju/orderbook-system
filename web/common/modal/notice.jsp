<%@ page language = "java" import = "java.util.*, java.sql.ResultSet, DataBase.DataBaseBean" pageEncoding = "utf-8" %>
...
<%
	...
	if(notice_rs.next()){
		...
		notice_time = notice_rs.getString("time");
	}
%>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p><%=notice_noticeContent%></p>
				<p style="text-align: right"><%=notice_time%></p>
			</div>
